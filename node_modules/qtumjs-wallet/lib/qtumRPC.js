...
const qtumd_rpc_1 = __importDefault(require("qtumd-rpc"));
const Network_1 = require("./Network");
class QtumRPC {
    constructor(config) {
        this.rpc = new qtumd_rpc_1.default(config);
    }
    generate(nblocks) {
...
exports.default = QtumRPC;
exports.rpcClient = new QtumRPC({
    user: "qtum",
    pass: "test",
    port: "18332",
    protocol: "http",
...
//# sourceMappingURL=qtumRPC.js.map