...
class Wallet {
    ...
    getBitcoinjsUTXOs() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const bitcoinjsUTXOs = uxtos.map((uxto) => (Object.assign({}, uxto, { pos: uxto.vout, value: uxto.satoshis, hash: uxto.txid }))).filter((utxo) => utxo.confirmations >= 500 || !utxo.isStake);
